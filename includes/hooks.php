...
add_action( 'muplugins_loaded',     'wp_site_aliases_register_site_filters',   -10    );

// Multiple Networks
add_filter( 'pre_get_site_by_path',    'wp_site_aliases_check_aliases_for_site',     20, 4 );
add_filter( 'pre_get_network_by_path', 'wp_site_aliases_check_aliases_for_network',  10, 2 );
add_action( 'muplugins_loaded',        'wp_site_aliases_register_network_filters',    -10    );
