...
/**
 * Add meta data field to a alias.
 *
 * @since 0.1.0
 *
...
/**
 * Remove metadata matching criteria from a alias.
 *
...
/**
 * Retrieve relatioship meta field for a alias.
 *
 * @since 0.1.0
 *
 * @param int    $id        Alias ID.
...
/**
 * Update alias meta field based on alias ID.
 *
